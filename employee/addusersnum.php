...
if ($_POST) {
    ...
    function adduser($API, $ip, $port, $user, $pass_r,$profiles, $limituptimes, $comments, $service, $num)
    {
    ...
    $output = adduser($API, $ip, $port, $user, $pass_r,$profiles, $limituptimes, $comments, $service, $num);
}
