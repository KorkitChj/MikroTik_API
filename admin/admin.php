            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        <button class="btn btn-danger" data-toggle="modal" data-target="#removeAllMemberModal" id="deleteAllMemberModalBtn">
                            <span class="glyphicon glyphicon-trash "></span>ลบข้อมูลแถวที่เลือก
                        </button><br /><br />
                        <table id="site_manage" class="table table-striped table-hover table-sm table-bordered display responsive nowrap" style="width:100%">
                            <thead class="aa">
                                <tr>
