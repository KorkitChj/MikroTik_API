...
if (!$_SESSION["admin_id"]) {
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col ">
                <nav class="navbar fixed-top navbar-icon-top navbar-expand-lg navbar-dark bg-dark bor-red">
    ...
    <div class="container-fluid box">
        <div class="row ">
            <div class="col">
                ...
                <table id="MemberTable" class="table table-striped table-hover table-bordered" style="width:100%">
                    <thead>
                        <tr>
                            <th width="1%"></th>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="confirmMemberModal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-primary" id="confirmBtn">Save changes</button>
                </div>
            </div>
        </div>
    </div>
