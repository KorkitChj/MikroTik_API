            ...
            <div class="row">
                <div class="form-group col-md-12">
                    <div class="btn-group btn-group-toggle" data-toggle="buttons">
                        <button class="btn btn-primary pull pull-right" data-toggle="modal" data-target="#addIppoolModal" id="addIppoolModalBtn">
                            <span class="glyphicon glyphicon-plus "></span>เพิ่ม IP Pool
                        </button>
                        <button class="btn btn-danger" data-toggle="modal" data-target="#removeAllPoolModal" id="removeAllPoolModalBtn">
                                <span class="glyphicon glyphicon-trash "></span>&nbsp;&nbsp;ลบข้อมูลแถวที่เลือก
                        </button>                      
                        <button type="button" class="btn btn-warning" onclick="window.location.href='pool.php'">
                            <img src="../img/refresh.png" width="20" title="Refresh">&nbsp;&nbsp;Reconnect</button>
                    </div>
                    <br><br>
                    <div class="table-responsive">
                        <table id="ip_pool" class="table table-striped table-bordered table-hover table-sm" width="100%">
                            <thead>
                                <tr>
