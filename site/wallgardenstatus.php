...
if (!$_SESSION["cus_id"]) {
    ...
    if ($API->connect($ip . ":" . $port, $user, $pass)) {
        ...
        } elseif ($_POST['wallgarden_id']) {
            $ide = implode(", ", $_POST['wallgarden_id']);
            $ARRAY = $API->comm("/ip/hotspot/walled-garden/ip/remove", array(
                "numbers" => $ide,
            ));
            echo "<div class=\"alert alert-success alert-dismissible fade show\">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto">
                            ...
                            <li class="nav-item dropdown active pad-a">
                                ...
                                <div class="dropdown-menu">
                                    <a href="#" class="dropdown-item active">สถานะ</a>
        ...
        <div class="row ">
            <div class="col">
                <form action="#" method="post" id="confirm">
                    <?php echo "<button  type=\"button\" style=\"margin:1em 1em\" class=\"btn btn-primary \"><a style=\"color:black;text-decoration:none\" href=\"addwallgarden.php?location_id=$location_id\"> ตั้งค่าเว็บไม่ต้อง Login</a></button>"; ?>
                    ...
                    <table id="example" class="table table-striped table-sm" style="width:100%">
                        ...
                        <tbody>
                            ...
                            for ($i = 0; $i < $num; $i++) {
                                $no = $i;
                                echo "<tr>";
                                echo "<td><input type=\"checkbox\" class=\"profile_checkbox\" name=\"wallgarden_id[]\" value=" . $ARRAY[$i]['comment'] . "></td>";
                                ...
                                {window.location='addwallgarden.php?action=edit_site&name=" . $ARRAY[$i]['comment'] . "&location_id=" . $location_id . "'}\">
                                ...
                                {window.location='wallgardenstatus.php?name_del=" . $ARRAY[$i]['comment'] . "&location_id=" . $location_id . "'}\">
