...
if ($API->connect($ip . ":" . $port, $user, $pass)) {
    ...
    foreach($ARRAY as $row) {       
        foreach($ARRAY2 as $row2){
            ...
            <button class="btn btn-warning disabled btn-sm" type="button"><span title="ปิด" class="glyphicon glyphicon-remove"></span></button>
            <button type="button" class="btn btn-info disabled btn-sm"><span title="แก้ไข" class="glyphicon glyphicon-edit"></span></button>
        ...
        foreach($ARRAY3 as $row3){
            ...
            <label class="checkbox">
                    <input type="checkbox" class="checkitem " name="address_id[]" value="'.$row['.id'].'">
            ...
            <button class="btn btn-warning btn-sm" type="button"  onclick="disableAddress(\''.$row['.id'].'\')"><span title="ปิด" class="glyphicon glyphicon-remove"></span></button>
            <button class="btn btn-info btn-sm" type="button" data-toggle="modal" data-target="#editIpModal" onclick="editIp(\'' . $row['.id'] . '\')"><span title="แก้ไข" class="glyphicon glyphicon-edit"></span></button>
