                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                            <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addServerModal" id="addServerModalBtn">
                                <span class="glyphicon glyphicon-plus "></span>เพิ่ม Server
                            </button>
                            <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#removeAllServerModal" id="removeAllServerModalBtn">
