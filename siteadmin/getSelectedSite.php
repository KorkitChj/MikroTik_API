...
if ($result["image_site"] != '') {
    $output['site_image'] = '<img src="../employee/sitelogo/' . $result["image_site"] . '" class="img-thumbnail" width="50" height="35" /><input type="hidden" name="hidden_site_image" value="' . $result["image_site"] . '" />';
} else {
