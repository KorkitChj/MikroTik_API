    ...
    <nav id="sidebar" class="sidebar-wrapper">
        <div class="sidebar-content">
            ...
            <div class="sidebar-header">
                <div class="user-pic">
                    <div id="load"><?php echo fetchimage($_SESSION["cus_id"]);?></div><button class="btn btn-primary" title="Add Image" data-toggle="modal" data-target="#addImageModal" id="addImageModalBtn"><i class="fas fa-user-plus"></i></button>
                </div>
                <div class="user-info">
                ...
                <form action="" id="editSite" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12 input-group">
                            ...
                            <input type="file" name="editsite_image" id="editsite_image" required>
