...
<form id="myform" action="../include/s_changpw.php" method="post">
        ...
        <table class="table mytable">
          <thead>
            <tr>
              ...
              error_reporting(0);
              $aa = $_REQUEST['id'];
              if ((!empty($aa)) || (empty($aa))) {
                $sl = $aa;
                if ($sl == 1) {
                  echo "<tr>";
                  echo '<td class="large-text" style="width:450px" bgcolor="#FFFFFF">Mikrotik/6เดือน จำกัดUser 400 คน </td>';
                  echo '<td class="large-text" style="width:370px" align="center" bgcolor="#FFFFFF">1 </td>';
                  echo '<td class="large-text" style="width:370px" align="center" bgcolor="#FFFFFF">500</td>';
                  echo '<td class="large-text" style="width:370px" align="center" bgcolor="#FFFFFF">
              <input type="radio" name="product" value="500" checked></input></td>';
                  echo "</tr>";
                } else {
                  echo "<tr>";
                  echo '<td class="large-text" style="width:450px" bgcolor="#FFFFFF">Mikrotik/6เดือน จำกัดUser 400 คน </td>';
                  ...
                  echo '<td class="large-text" style="width:370px" align="center" bgcolor="#FFFFFF">500</td>';
                  echo '<td class="large-text" style="width:370px" align="center" bgcolor="#FFFFFF">
                <input type="radio" name="product" value="500"></input></td>';
                  echo "</tr>";
                }
              }
              if ((!empty($aa)) || (empty($aa))) {
                ...
                if ($sl1 == 2) {
                  echo "<tr>";
                  echo '<td class="large-text" style="width:450px" bgcolor="#FFFFFF">Mikrotik/1ปี ไม่จำกัด User</td>';
                  echo '<td class="large-text" style="width:370px" align="center" bgcolor="#FFFFFF">1 </td>';
                  echo '<td class="large-text" style="width:370px" align="center" bgcolor="#FFFFFF">1000</td>';
                  echo '<td class="large-text" style="width:370px" align="center" bgcolor="#FFFFFF">
                <input type="radio" name="product" value="1000" checked></input></td>';
                  echo "</tr>";
                } else {
                  echo "<tr>";
                  echo '<td class="large-text" style="width:450px" bgcolor="#FFFFFF">Mikrotik/1ปี ไม่จำกัด User</td>';
                  ...
                  echo '<td class="large-text" style="width:370px" align="center" bgcolor="#FFFFFF">1000</td>';
                  echo '<td class="large-text" style="width:370px" align="center" bgcolor="#FFFFFF">
                <input type="radio" name="product" value="1000"></input></td>';
                  echo "</tr>";
                }
              }
              ?>
          ...
          <div class="actions">
            <div class='form-group'>
              <div class='text-right'>
                ...
                <!-- <a class="btn btn-danger pull-right" style="margin-right:7px;" href="" onclick ="window.history.back();">ยกเลิก</a> -->
