  ...
  <div class="container" style="margin-top:10px">
    <form id="s_payment" action="" method="POST">
      <div class="row" style="margin:5px">
        <div class="col-lg-12 bg-light shadow-lg p-3 mb-5 rounded">
          ...
          <div class="row d-flex justify-content-center">
            <div class="col-md-6">
              ...
              echo "<label for=\"date\"><b><i class=\"far fa-calendar-alt\"></i>&nbsp;กำหนดชำระภายใน:</b></label>" . "<input class=\"dl btn form-control\" readonly=\"readonly\" value=\"" . DateThai($datethai) . "  (3 วัน)\" name=\"date\" id=\"date\" />";
              ?>
